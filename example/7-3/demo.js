...
// Variable
var emptyVar; // A statement that creats a variable called "emptyVar"
//console.log(emptyVar); // undefined

var num = 5; //A statement that creats a variable called "num" with a defualt numeric value
//console,log(num);

var x = 10, y = 20, z = 40; //Create multiple variable in one single statement
...
//var badQuotation = 'Ah" // Different quotation marks cause errors
//console.log(anothername); //Error: Everything is case-sensitive in JavaScript

x = 'This is a variable called x'; //Change the value to a different type of data; not recommened
//console.log(x);
